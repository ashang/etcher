 ...
 *
 * @example
 * const anonymized = utils.hidePaths({
 ...
 * > }
 */
exports.hideObjectAbsolutePaths = (object) => {
  return _.deepMapValues(object, (value) => {
    if (!_.isString(value)) {
      return value;
    }

    if (os.platform() !== 'win32' && _.startsWith(value, '/dev/')) {
      return value;
    }

    if (os.platform() === 'win32' && _.startsWith(value, '\\\\.\\')) {
      return value;
    }
